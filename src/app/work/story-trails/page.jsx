...
const PROJECT = {
  ...
  tagline: "Original score, sound design and mix for the UK's largest immersive storytelling project.",
...
Composition, sound design and mix were a single process throughout.`,
  ...
  metadataRow: "COMPOSER · SOUND DESIGN · MIX  |  STORYFUTURES / ISO DESIGN  |  BBC  |  2022",
      ...
      <main className="story-trails-page">
        <article className="story-trails-layout">
          <div className="story-trails-left">
            <p className="story-trails-type">{PROJECT.type} · {PROJECT.year}</p>
