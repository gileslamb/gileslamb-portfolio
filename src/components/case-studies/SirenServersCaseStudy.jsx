...
export const SIREN_SERVERS_PROJECT = {
  id: "siren-servers",
  title: "Siren Servers",
  year: "2015",
  type: "VR INSTALLATION",
  tagline:
    "Sound design and composition for an immersive VR installation presented at Sonica, Glasgow.",
...
export function SirenServersCaseStudy({
  backHref = "/#work",
  backLabel = "← Back to Selected Work",
}) {
  const PROJECT = SIREN_SERVERS_PROJECT;
  return (
    <>
      <Nav />
      <main className="siren-servers-page">
        <article className="siren-servers-layout">
          <div className="siren-servers-left">
            <p className="siren-servers-type">
