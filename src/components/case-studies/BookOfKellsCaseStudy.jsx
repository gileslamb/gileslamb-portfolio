...
export async function BookOfKellsCaseStudy({
  backHref = "/#work",
  ...
  const typeLine = [frontmatter.category, frontmatter.year]
    .filter(Boolean)
    .join(" · ");
      ...
      <main className="book-of-kells-page">
        <article className="book-of-kells-layout">
          <div className="book-of-kells-left">
            <p className="book-of-kells-type">
              {typeLine || frontmatter.category}
            </p>
